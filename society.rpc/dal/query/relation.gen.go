...
func newRelation(db *gorm.DB, opts ...gen.DOOption) relation {
	...
	_relation.FromUserId = field.NewUint(tableName, "from_user_id")
	_relation.ToUserId = field.NewUint(tableName, "to_user_id")
	_relation.RelType = field.NewUint8(tableName, "rel_type")
...
func (r *relation) updateTableName(table string) *relation {
	...
	r.FromUserId = field.NewUint(table, "from_user_id")
	r.ToUserId = field.NewUint(table, "to_user_id")
	r.RelType = field.NewUint8(table, "rel_type")
