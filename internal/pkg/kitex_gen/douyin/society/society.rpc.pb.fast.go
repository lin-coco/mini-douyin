...
func (x *FollowerListRequest) fastWriteField2(buf []byte) (offset int) {
	...
	offset += fastpb.WriteInt64(buf[offset:], 2, x.GetPageNo())
	return offset
}
...
func (x *SocietyInfoRequest) fastWriteField1(buf []byte) (offset int) {
	...
	offset += fastpb.WriteInt64(buf[offset:], 1, x.GetMyId())
	return offset
}
...
func (x *MessageChatRequest) fastWriteField1(buf []byte) (offset int) {
	...
	offset += fastpb.WriteInt64(buf[offset:], 1, x.GetMyUserId())
	return offset
}
...
func (x *MessageChatRequest) fastWriteField2(buf []byte) (offset int) {
	...
	offset += fastpb.WriteInt64(buf[offset:], 2, x.GetFriendUserId())
	return offset
}
...
func (x *Message) fastWriteField6(buf []byte) (offset int) {
	...
	offset += fastpb.WriteString(buf[offset:], 6, x.GetCreateTimeFormat())
	return offset
}
...
func (x *FollowerListRequest) sizeField2() (n int) {
	...
	n += fastpb.SizeInt64(2, x.GetPageNo())
	return n
}
...
func (x *SocietyInfoRequest) sizeField1() (n int) {
	...
	n += fastpb.SizeInt64(1, x.GetMyId())
	return n
}
...
func (x *MessageChatRequest) sizeField1() (n int) {
	...
	n += fastpb.SizeInt64(1, x.GetMyUserId())
	return n
}
...
func (x *MessageChatRequest) sizeField2() (n int) {
	...
	n += fastpb.SizeInt64(2, x.GetFriendUserId())
	return n
}
...
func (x *Message) sizeField6() (n int) {
	...
	n += fastpb.SizeString(6, x.GetCreateTimeFormat())
	return n
}
