...
func main() {
	...
	err = db.AutoMigrate(&model.User{}, &model.Video{}, &model.UserFavourite{}, &model.Comment{}, &model.Relation{}, &model.MessageChat{})
	if err != nil {
		panic("autoMigrate failed")
	}
	g.UseDB(db)
	g.ApplyBasic(model.User{}, model.Video{}, model.UserFavourite{}, model.Comment{}, model.Relation{}, model.MessageChat{})
