...
func newComment(db *gorm.DB, opts ...gen.DOOption) comment {
	...
	_comment.FromUserId = field.NewUint(tableName, "from_user_id")
	_comment.ToVideoId = field.NewUint(tableName, "to_video_id")
...
func (c *comment) updateTableName(table string) *comment {
	...
	c.FromUserId = field.NewUint(table, "from_user_id")
	c.ToVideoId = field.NewUint(table, "to_video_id")
...
func (c *comment) fillFieldMap() {
	...
	c.fieldMap["from_user_id"] = c.FromUserId
	c.fieldMap["to_video_id"] = c.ToVideoId
}
